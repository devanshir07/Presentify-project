            ...
            >
                ...
                >
                    <div className="flex flex-col gap-4 p-4 md:p-8">
                        ...
                        >
                            <button type="button" className="flex w-full items-center justify-center gap-2 rounded-lg bg-blue-500 px-8 py-3 text-center text-sm font-semibold text-white outline-none ring-blue-300 transition duration-200 hover:bg-blue-600 focus-visible:ring active:bg-blue-700 md:text-base">
                            ...
                            <button type="button" className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-8 py-3 text-center text-sm font-semibold text-gray-800 outline-none transition duration-200 hover:bg-gray-100 focus-visible:ring md:text-base">
                                <svg className="h-5 w-5 shrink-0" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
